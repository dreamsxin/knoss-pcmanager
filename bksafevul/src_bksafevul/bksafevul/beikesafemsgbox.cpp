...
UINT_PTR CBkSafeMsgBox2::ShowMultLine(LPCWSTR lpszText, 
									  LPCWSTR lpszCaption /* = NULL */, 
									  UINT uType /* = MB_OK */, 
									  BOOL *pbNoNotifyLater /* = NULL */, 
...
{
	CBkSafeMsgBox2 msgbox;
	return msgbox.ShowMutlLineMsg(lpszText, lpszCaption, uType, pbNoNotifyLater, hWndParent);
}
...
LRESULT CBkSafeMsgBox::OnDestory()
{
	g_bkMsgBox = FALSE;
	SetMsgHandled(FALSE);
	return TRUE;
