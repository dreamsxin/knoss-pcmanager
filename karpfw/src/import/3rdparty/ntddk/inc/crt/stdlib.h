...
#if __STDC_WANT_SECURE_LIB__
_CRTIMP_ALT void __cdecl qsort_s(__inout_bcount(_NumOfElements* _SizeOfElements) void * _Base, 
        __in rsize_t _NumOfElements, __in rsize_t _SizeOfElements,
        __in int (__cdecl * _PtFuncCompare)(void *, const void *, const void *), void *_Context);
#endif
...
_CRTIMP_ALT __checkReturn_opt errno_t __ALTDECL _itoa_s(__in int _Value, __out_ecount_z(_Size) char * _DstBuf, __in size_t _Size, __in int _Radix);
...
#if     _INTEGRAL_MAX_BITS >= 64
_CRTIMP_ALT __checkReturn_opt errno_t __ALTDECL _i64toa_s(__in __int64 _Val, __out_ecount_z(_Size) char * _DstBuf, __in size_t _Size, __in int _Radix);
_CRTIMP _CRT_INSECURE_DEPRECATE(_i64toa_s) char * __cdecl _i64toa(__in __int64 _Val, __out_z char * _DstBuf, __in int _Radix);
_CRTIMP_ALT __checkReturn_opt errno_t __ALTDECL _ui64toa_s(__in unsigned __int64 _Val, __out_ecount_z(_Size) char * _DstBuf, __in size_t _Size, __in int _Radix);
...
#endif
_CRTIMP_ALT __checkReturn_opt errno_t __ALTDECL _ltoa_s(__in long _Val, __out_ecount_z(_Size) char * _DstBuf, __in size_t _Size, __in int _Radix);
...
#endif
_CRTIMP_ALT __checkReturn_opt errno_t __ALTDECL _ultoa_s(__in unsigned long _Val, __out_ecount_z(_Size) char * _DstBuf, __in size_t _Size, __in int _Radix);
...
_CRTIMP_ALT __checkReturn_wat errno_t __cdecl _ecvt_s(__out_ecount_z(_Size) char * _DstBuf, __in size_t _Size, __in double _Val, __in int _NumOfDights, __out int * _PtDec, __out int * _PtSign);
...
_CRTIMP_ALT errno_t __ALTDECL _gcvt_s(__out_ecount_z(_Size) char * _DstBuf, __in size_t _Size, __in double _Val, __in int _NumOfDigits);
...
_CRTIMP_ALT __checkReturn_wat errno_t   __ALTDECL _makepath_s(__out_ecount_z(_Size) char * _PathResult, __in_opt size_t _Size, __in_z_opt const char * _Drive, __in_z_opt const char * _Dir, __in_z_opt const char * _Filename,
...
_CRTIMP_ALT __checkReturn_wat errno_t  __ALTDECL _splitpath_s(__in_z const char * _FullPath, 
