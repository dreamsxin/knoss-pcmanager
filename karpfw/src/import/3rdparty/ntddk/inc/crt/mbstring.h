...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbscat_s) unsigned char * __cdecl _mbscat(unsigned char *, const unsigned char *);
_CRTIMP_ALT errno_t __cdecl _mbscat_s(__inout_bcount_z(_DstSizeInBytes) unsigned char * _Dst, __in size_t _DstSizeInBytes, __in_z const unsigned char * _Src);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbscpy_s) unsigned char * __cdecl _mbscpy(unsigned char *, const unsigned char *);
_CRTIMP_ALT errno_t __cdecl _mbscpy_s(__out_bcount_z(_DstSizeInBytes) unsigned char * _Dst, __in size_t _DstSizeInBytes, __in_z const unsigned char * _Src);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbsnbcat_s) unsigned char * __cdecl _mbsnbcat(__inout_z unsigned char *, __in_z const unsigned char *, size_t);
_CRTIMP_ALT errno_t __ALTDECL _mbsnbcat_s(__inout_bcount_z(_DstSizeInBytes) unsigned char * _Dst, __in size_t _DstSizeInBytes, __in_z const unsigned char * _Src, __in size_t _MaxCount);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbsnbcpy_s) unsigned char * __cdecl _mbsnbcpy(__out_z unsigned char *, __in_z const unsigned char *, size_t);
_CRTIMP_ALT errno_t __ALTDECL _mbsnbcpy_s(__out_bcount_z(_DstSizeInBytes) unsigned char * _Dst, __in size_t _DstSizeInBytes, __in_z const unsigned char * _Src, __in size_t _MaxCount);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbsnbset_s) unsigned char * __cdecl _mbsnbset(__inout_bcount_z(_MaxCount) unsigned char *, __in unsigned int, __in size_t _MaxCount);
...
_CRTIMP_ALT errno_t __ALTDECL _mbsnbset_s(__inout_bcount_z(_DstSizeInBytes) unsigned char * _Dst, __in size_t _DstSizeInBytes, __in unsigned int _Ch, __in size_t _MaxCount);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbsncat_s) unsigned char * __cdecl _mbsncat(unsigned char *, const unsigned char *, size_t);
_CRTIMP_ALT errno_t __ALTDECL _mbsncat_s(__inout_bcount_z(_DstSizeInBytes) unsigned char * _Dst, __in size_t _DstSizeInBytes, __in_z const unsigned char * _Src, __in size_t _MaxCount);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbsncpy_s) unsigned char * __cdecl _mbsncpy(__out_z unsigned char *, __in_z const unsigned char *, __in size_t);
_CRTIMP_ALT errno_t __ALTDECL _mbsncpy_s(__out_bcount_z(_DstSizeInBytes) unsigned char * _Dst, __in size_t _DstSizeInBytes, __in_z const unsigned char * _Src, __in size_t _MaxCount);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbsnset_s) unsigned char * __cdecl _mbsnset(__inout_bcount_z(_MaxCount) unsigned char * _Dst, __in unsigned int _Val, __in size_t _MaxCount);
...
_CRTIMP_ALT errno_t __ALTDECL _mbsnset_s(__inout_bcount_z(_DstSizeInBytes) unsigned char * _Dst, __in size_t _DstSizeInBytes, __in unsigned int _Val, __in size_t _MaxCount);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbsset_s) unsigned char * __cdecl _mbsset(__inout_z unsigned char * _Str, __in unsigned int _Val);
...
_CRTIMP_ALT errno_t __ALTDECL _mbsset_s(__inout_bcount_z(_DstSizeInBytes) unsigned char * _Dst, __in size_t _DstSizeInBytes, __in unsigned int _Val);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbstok_s) __checkReturn unsigned char * __cdecl _mbstok(__inout_z_opt unsigned char * _Str, __in_z const unsigned char * _Delim);
...
_CRTIMP_ALT __checkReturn unsigned char * __ALTDECL _mbstok_s(__inout_z_opt unsigned char *_Str, __in_z const unsigned char * _Delim, __deref_inout_z_opt unsigned char ** _Context);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbccpy_s) void __cdecl _mbccpy(__out_bcount(2) unsigned char * _Dst, __in_z const unsigned char * _Src);
...
_CRTIMP_ALT errno_t __ALTDECL _mbccpy_s(__out_bcount(_DstSizeInBytes) unsigned char * _Dst, __in size_t _DstSizeInBytes, __out_opt int * _PCopied, __in_z const unsigned char * _Src);
