...
public:
                strstreambuf();
                strstreambuf(int);
                strstreambuf(__in_xcount(size) char *, int size, __in_opt char * = 0);
                strstreambuf(__in_xcount(size) unsigned char *, int size, __in_opt unsigned char * = 0);
                strstreambuf(__in_xcount(size) signed char *, int size, __in_opt signed char * = 0);
...
virtual streambuf* setbuf(__in char *, int);
...
public:
                istrstream(__in char *);
                istrstream(__in char *, int);
                ~istrstream();
...
public:
                ostrstream();
                ostrstream(__in char *, int, int = ios::out);
                ~ostrstream();
