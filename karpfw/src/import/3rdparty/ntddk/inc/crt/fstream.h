...
static  const int       text;
                        ...
                        filebuf();
                        filebuf(filedesc);
                        filebuf(filedesc, __in_z char *, int);
                        ~filebuf();
...
virtual streambuf*      setbuf(__in_z_opt char *, int);
...
public:
        ...
        ifstream(filedesc);
        ifstream(filedesc, __in_z_opt char *, int);
        ~ifstream();

        streambuf * setbuf(__in_z_opt char *, int);
...
public:
        ...
        ofstream(filedesc);
        ofstream(filedesc, __in_z_opt char *, int);
        ~ofstream();
...
public:
        ...
        fstream(filedesc);
        fstream(filedesc, __in_z_opt char *, int);
        ~fstream();
