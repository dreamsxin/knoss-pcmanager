...
_CRTIMP __checkReturn __bcount_opt(_NumOfElements * _SizeOfElements) void * __cdecl _recalloc_dbg
(
        __inout_opt void * _Memory,
        __in size_t _NumOfElements,
        __in size_t _SizeOfElements,
...
_CRTIMP __checkReturn __bcount_opt(_NumOfElements * _SizeOfElements) void * __cdecl _aligned_recalloc_dbg
(
        __inout_opt void * _Memory,
        __in size_t _NumOfElements,
        __in size_t _SizeOfElements,
...
_CRTIMP __checkReturn __bcount_opt(_NumOfElements * _SizeOfElements) void * __cdecl _aligned_offset_recalloc_dbg
(
        __inout_opt void * _Memory,
        __in size_t _NumOfElements,
        __in size_t _SizeOfElements,
