...
_CRT_INSECURE_DEPRECATE_CORE(_strset_s) char *  __cdecl _strset(__inout_z char * _Str, __in int _Val);
_CRTIMP_ALT __checkReturn_wat errno_t __ALTDECL _strset_s(__inout_ecount_z(_DstSize) char * _Dst, __in size_t _DstSize, __in int _Value);
#if __STDC_WANT_SECURE_LIB__
_CRTIMP_ALT __checkReturn_wat errno_t __ALTDECL strcpy_s(__out_ecount_z(_DstSize) char * _Dst, __in rsize_t _DstSize, __in_z const char * _Src);
#endif
...
#if __STDC_WANT_SECURE_LIB__
_CRTIMP_ALT __checkReturn_wat errno_t __ALTDECL strcat_s(__inout_ecount_z(_DstSize) char * _Dst, __in rsize_t _DstSize, __in_z const char * _Src);
#endif
...
_CRTIMP_ALT __checkReturn size_t  __ALTDECL strnlen(__in_ecount_z(_MaxCount)  const char * _Str, __in size_t _MaxCount);
...
#endif
#if __STDC_WANT_SECURE_LIB__
_CRTIMP_ALT __checkReturn_wat errno_t __ALTDECL memmove_s(__out_bcount_part_opt(_DstSize,_MaxCount) void * _Dst, __in rsize_t _DstSize, __in_bcount_opt(_MaxCount) const void * _Src, __in rsize_t _MaxCount);
#endif
...
_CRTIMP_ALT __checkReturn_wat errno_t __ALTDECL _strlwr_s(__inout_ecount_z(_Size) char * _Str, __in size_t _Size);
...
#if __STDC_WANT_SECURE_LIB__
_CRTIMP_ALT __checkReturn_wat errno_t __ALTDECL strncat_s(__inout_ecount_z(_DstSize) char * _Dst, __in rsize_t _DstSize, __in_z const char * _Src, __in rsize_t _MaxCount);
#endif
...
#if __STDC_WANT_SECURE_LIB__
_CRTIMP_ALT __checkReturn_wat errno_t __ALTDECL strncpy_s(__out_ecount_z(_DstSize) char * _Dst, __in rsize_t _DstSize, __in_z_opt const char * _Src, __in rsize_t _MaxCount);
#endif
...
_CRT_INSECURE_DEPRECATE_CORE(_strnset_s) _CRTIMP char *  __cdecl _strnset(__inout_z char * _Str, __in int _Val, __in size_t _MaxCount);
_CRTIMP_ALT __checkReturn_wat errno_t __ALTDECL _strnset_s(__inout_ecount_z(_Size) char * _Str, __in size_t _Size, __in int _Val, __in size_t _MaxCount);
...
_CRT_INSECURE_DEPRECATE_CORE(strtok_s) _CRTIMP __checkReturn char *  __cdecl strtok(__inout_z_opt char * _Str, __in_z const char * _Delim);
#if __STDC_WANT_SECURE_LIB__
_CRTIMP_ALT __checkReturn char *  __ALTDECL strtok_s(__inout_z_opt char * _Str, __in_z const char * _Delim, __deref_inout_z_opt char ** _Context);
#endif
_CRTIMP_ALT __checkReturn_wat errno_t __ALTDECL _strupr_s(__inout_ecount_z(_Size) char * _Str, __in size_t _Size);
...
_CRTIMP_ALT __checkReturn size_t __ALTDECL wcsnlen(__in_ecount_z(_MaxCount) const wchar_t * _Src, __in size_t _MaxCount);
#if __STDC_WANT_SECURE_LIB__ && !defined (__midl)
