...
typedef struct _TDI_CONNECTION_INFORMATION {
    ...
    __field_bcount(UserDataLength) PVOID UserData;             // pointer to user data buffer
    LONG OptionsLength;         // length of follwoing buffer
    __field_bcount(OptionsLength) PVOID Options;              // pointer to buffer containing options
    LONG RemoteAddressLength;   // length of following buffer
    __field_bcount(RemoteAddressLength) PVOID RemoteAddress;        // buffer containing the remote address
