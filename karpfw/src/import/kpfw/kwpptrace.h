...
#define WPP_CONTROL_GUIDS \
	...
	WPP_DEFINE_BIT(FLAG_NDIS_MAIN)			\
	WPP_DEFINE_BIT(FLAG_NDIS_PROTOCOL)		\
	WPP_DEFINE_BIT(FLAG_NDIS_MINIPORT)		\
	WPP_DEFINE_BIT(FLAG_NDIS_IP)			\
	WPP_DEFINE_BIT(FLAG_NDIS_ARP)			\
	WPP_DEFINE_BIT(FLAG_NDIS_ADV_IP)		\
)
...
inline LPCWSTR GetProtoTypeName(PROTO_TYPE t)
{
	switch (t)
	{
	case enumPT_TCP:
	...
	case enumPT_UDP:
		return L"enumPT_UDP";
	case enumPT_ICMP:
		return L"enumPT_ICMP";
	case enumPT_IP:
		return L"enumPT_IP";
	case enumPT_IGMP:
		return L"enumPT_IGMP";
	case enumPT_RAWIP:
		return L"enumPT_RAWIP";
	case enumPT_LANMAN:
		return L"enumPT_LANMAN";
	case enumPT_HTTP:
		return L"enumPT_HTTP";
	case enumPT_FILE_MON:
		return L"enumPT_FILE_MON";
	}
	return L"enumPT_Unknow";
}
