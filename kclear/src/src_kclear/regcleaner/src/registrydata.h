...
private:
	static bool CheckUninstall(HKEY hKey, const TCHAR* lpszSubKeyName, LPVOID param);
	static bool CheckValueNamePath(HKEY hKey, const TCHAR* lpszValueName, const void* lpValueData, DWORD dwType, DWORD dwDataLen, LPVOID param);
	static bool CheckOpenSaveMRUSubKey(HKEY hKey, const TCHAR* lpszSubKeyName, LPVOID param);
	static bool CheckOpenSaveMRUDataPath(HKEY hKey, const TCHAR* lpszValueName, const void* lpValueData, DWORD dwType, DWORD dwDataLen, LPVOID param);
	static bool CheckFileAssociateSubKey(HKEY hKey, const TCHAR* lpszSubKeyName, LPVOID param);
	static bool CheckTypeLibSubKey(HKEY hKey, const TCHAR* lpszSubKeyName, LPVOID param);
	static bool CheckTypeLibWin32Key(HKEY hKey, const TCHAR* lpszSubKeyName, LPVOID param);
	static bool CheckClsidSubKey(HKEY hKey, const TCHAR* lpszSubKeyName, LPVOID param);
	static bool CheckClsidCodeBase(HKEY hKey, const TCHAR* lpszSubKeyName, LPVOID param);
	static bool CheckFileExts(HKEY hKey, const TCHAR* lpszSubKeyName, LPVOID param);
	static bool CheckOfficeOpenHistory(HKEY hKey, const TCHAR* lpszSubKeyName, LPVOID param);
	static bool CheckMUICache(HKEY hKey, const TCHAR* lpszValueName, const void* lpValueData, DWORD dwType, DWORD dwDataLen, LPVOID param);
	static bool CheckHelp(HKEY hKey, const TCHAR* lpszValueName, const void* lpValueData, DWORD dwType, DWORD dwDataLen, LPVOID param);
	static bool	CheckAppPath(HKEY hKey, const TCHAR* lpszSubKeyName, LPVOID param);
    static bool CheckMenuOrder(HKEY hKey, const TCHAR* lpszSubKeyName, LPVOID param);
...
HRESULT	CheckFilePath(tstring& strPath, CRegistryData::PATH_TYPE ptPath = CRegistryData::PT_ALL);
